<cfcomponent displayname="Blizzard" output="false" extends="kathune.KathuneTentacle">

	<cffunction name="init" returntype="kathune.tentacle.Blizzard.BlizzardTentacle" access="private" output="false">
