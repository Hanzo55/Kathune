<cfcomponent displayname="RP-PvPTentacle" output="false" extends="tentacle.LookingForGuild.Europe.Horde.HordeTentacle" implements="interface.ITentacle">

	<cffunction name="init" returntype="tentacle.LookingForGuild.Europe.Horde.RP-PvPTentacle" access="public" output="false">
