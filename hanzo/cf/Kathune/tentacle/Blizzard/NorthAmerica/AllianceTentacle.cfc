<cfcomponent displayname="Alliance" output="false" extends="hanzo.cf.Kathune.tentacle.Blizzard.NorthAmerica.NorthAmericaTentacle" implements="hanzo.cf.Kathune.interface.ITentacle">

    <cffunction name="init" returntype="hanzo.cf.Kathune.tentacle.Blizzard.NorthAmerica.AllianceTentacle" access="public" output="false">
