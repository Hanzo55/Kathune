<cfcomponent displayname="Blizzard" output="false" extends="hanzo.cf.Kathune.KathuneTentacle">

    <cffunction name="init" returntype="hanzo.cf.Kathune.tentacle.Blizzard.BlizzardTentacle" access="private" output="false">
