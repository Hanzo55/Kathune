<cfcomponent displayname="PvETentacle" output="false" extends="tentacle.MMOChampion.NorthAmerica.NorthAmericaTentacle" implements="interface.ITentacle">

	<cffunction name="init" returntype="tentacle.MMOChampion.NorthAmerica.PvETentacle" access="public" output="false">
