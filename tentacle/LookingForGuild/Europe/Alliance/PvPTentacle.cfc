<cfcomponent displayname="PvPTentacle" output="false" extends="tentacle.LookingForGuild.Europe.Alliance.AllianceTentacle" implements="interface.ITentacle">

	<cffunction name="init" returntype="tentacle.LookingForGuild.Europe.Alliance.PvPTentacle" access="public" output="false">
